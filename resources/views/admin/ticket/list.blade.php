                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($ticket as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $row->userticket ? $row->userticket->name : null }}
                                                    </td>
                                                    <td>
                                                        {{ $row->title }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif
                                                        <a href="{{ route('admin.ticket.detail', $row->id) }}"
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            var url = '{{ url('admin/ticket/delete') }}' + '/' + id;
                            $.ajax({
                                url: url,
                                type: 'DELETE',
                                dataType: 'json',
            ...
            $("#table-1").on("click", "button#statusChange", function() {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            var token = $("meta[name='csrf-token']").attr("content");
                            var url = '{{ url('admin/ticket/status') }}' + '/' + id;
                            $.ajax({
                                url: url,
                                type: 'GET',
                                dataType: 'json',
