        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                ...
                @else
                    ...
                    @endif
                        <a href="{{ route('request.epin.load') }}"
                            class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Buy
                            Epin</a>
                @endauth
            </div>
        @endif
