		...
		return (
			e.hasOwnProperty('classes') &&
				...
				e.classes.hasOwnProperty('slide') &&
					(n.classes.slide = Object.assign({}, t.classes.slide, e.classes.slide)),
				e.classes.hasOwnProperty('arrow') &&
					(n.classes.arrow = Object.assign({}, t.classes.arrow, e.classes.arrow)),
			...
			Sizes: function (t, e, n) {
				var i = {
					setupSlides: function () {
						for (
							var t = ''.concat(this.slideWidth, 'px'), n = e.Html.slides, i = 0;
							i < n.length;
							i++
						)
							n[i].style.width = t;
						...
						move: function (i) {
							if (!t.disabled) {
								var a = t.settings,
									...
									g = Math.sqrt(p + m),
									y = Math.sqrt(m);
								if (!((180 * (r = Math.asin(y / g))) / Math.PI < u))
									return !1;
								i.stopPropagation(),
						...
						match: function (t) {
							if (void 0 !== window.matchMedia)
								for (var e in t)
									if (
										t.hasOwnProperty(e) &&
										window.matchMedia('(max-width: '.concat(e, 'px)'))
											.matches
									)
										return t[e];
							return s;
